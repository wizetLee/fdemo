...
import 'package:fdemo/gesture_widget/jz_slider.dart';
...
class _GestureWidgetState extends State<GestureWidget> {
  ...
  JZRangeViewController rangeController =
      JZRangeViewController(minValue: 0, maxValue: 100);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: JZSlider(initialValue: value, onChanged: (value) {
                print("value = ${value}");
