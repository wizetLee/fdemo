import 'package:fdemo/graph/jz_graph.dart';
import 'package:flutter/material.dart';
import 'dart:math';

class JZRGBackgroundPainter extends CustomPainter {
  EdgeInsets padding;
  int count;
  ...
  @override
  bool shouldRepaint(JZRGBackgroundPainter oldDelegate) {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (count <= 1) {
      ...
      for (int i = 0; i < count; i++) {
        ...
        final path = JZGraphTool().getDashedPath(
