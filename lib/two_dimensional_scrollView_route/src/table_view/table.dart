...
class RenderTableViewport extends RenderTwoDimensionalViewport {
  ...
  void _updateFirstAndLastVisibleCell() {
    ...
    print("${this} _updateFirstAndLastVisibleCell: _firstNonPinnedRow=${_firstNonPinnedRow} _lastNonPinnedRow=${_lastNonPinnedRow}");
  }
  ...
  void layoutChildSequence() {
    ...
    var d = delegate as TwoDimensionalChildBuilderDelegate;
    int? maxRowIndex = d.maxXIndex;
    int? maxColumnIndex = d.maxYIndex;
